...
export default BigSqueeze = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image
        source={require("../../assets/images/BigSqueeze/background.png")}
      />
      <Text style={styles.bigSqueezeAngry}>Are you feeling angry?</Text>
      <Image
        style={styles[`imageBigSqueeze${current}`]}
        source={screens[current].image}
      />
      ...
      {current !== 1 ? (
        ...
        <View style={styles.rightArrow}>
          <Image
            source={require("../../assets/images/misc/disabledRight.png")}
          />
        </View>
      )}
      ...
      {current !== 0 ? (
        ...
        <View style={styles.leftArrow}>
          <Image
            source={require("../../assets/images/misc/disabledLeft.png")}
          />
        </View>
      )}
    </View>
